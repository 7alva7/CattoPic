      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative bg-white dark:bg-gray-900 rounded-2xl overflow-hidden w-full max-w-6xl max-h-[90vh] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] dark:shadow-2xl border border-gray-200/80 dark:border-gray-700/50 ring-1 ring-black/[0.05] dark:ring-white/[0.05] flex flex-col"
          ...
          >
            ...
            <div className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-[minmax(0,1.3fr)_minmax(20rem,0.9fr)]">
              <div className="min-h-[16rem] border-b border-gray-100 dark:border-gray-800 lg:min-h-0 lg:border-b-0 lg:border-r">
